...
public class THttpClient extends TTransport {
	...
	protected static boolean turnOffSSLHostnameVerifier = false;
	
	static protected HostnameVerifier alwaysTrueHostnameVerifier = new HostnameVerifier() {
	...
	static {
		String res = System.getProperty("SSLHostnameVerifier");
		if (res != null && res.equalsIgnoreCase("true")) {
			turnOffSSLHostnameVerifier = true;
		}
	}
	...
	public void flush() throws TTransportException {
		...
		try {
			...
			if (turnOffSSLHostnameVerifier
			    && connection instanceof HttpsURLConnection) {
				((HttpsURLConnection) connection)
				    .setHostnameVerifier(alwaysTrueHostnameVerifier);
			}
